...
import com.mbv.airtime.report.model.ProviderTxnSummaryModel;
...
public class ProviderTxnSummaryReport extends BaseReport {
...
//	private String inputDateTimeFormat="yyyy-MM-dd";
	...
	public void processInputParams() {
		try{
			...
			validate(ProviderTxnSummaryModel.build(inputParams));
		}catch (Exception e) {
	...
	private void validate(ProviderTxnSummaryModel model) throws Exception {
...
//					already GMT+7
					...
					excelWriter.WriteLong(startCol++,startRow,new Long(record.getTotalTxn()),excelWriter.longFormatDashDot(false,10));
