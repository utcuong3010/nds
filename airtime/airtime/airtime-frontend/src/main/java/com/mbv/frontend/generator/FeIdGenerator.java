...
public class FeIdGenerator implements IdGenerator {
	protected static final Log log = LogFactory.getLog(FeIdGenerator.class);
	...
	public FeIdGenerator(long initialValue, long maxValue,
