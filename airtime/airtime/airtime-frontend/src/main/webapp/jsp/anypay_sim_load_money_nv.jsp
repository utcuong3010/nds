...
<body>
<div align="center">
<div style="height:40px;"><span><b>N&#7841;p ti&#7873;n v&#224;o t&#224;i kho&#7843;n Sim Anypay
</b></span></div>
<br>
	...
	<TBODY>
		...
		<s:form action="/anypay_sim_load_money_s.mbv">
			...
			<TR bgcolor="#E3EFFF" onmouseout="td_onmouseout(this,color_out2)"
				onmouseover="td_onmouseover(this,color_over2)" class="Table_TR">
				<TD>S&#7889; ti&#7873;n</TD>
				<TD><s:textfield name="proAcc.amount"
					cssStyle="Table_TR" maxlength="40" size="30" value="%{proAcc.amount}"
