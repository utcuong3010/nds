...
<div align="center">
<div style="height:40px;"><span><b>Truy v&#7845;n giao d&#7883;ch Mobifone
</b></span></div>
<s:form action="/mobifone_transaction_lv.mbv" id="search_airtime_transaction_lv">
		...
		<tr align="left">
			...
			<td width="30%">
				<s:select name="txnModel.connType"
						list="%{#request.providerAccountMap}" value="%{txnModel.connType}" disabled="true"/>
...
<TABLE class=tinyborder cellSpacing=0 cellPadding=0 width=70%
	...
	<tr>
		...
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">M&#227; GD (Mobifone)</span></td>
	...
	<s:iterator status="status" value="%{#request.pageView.items}">
		...
		<s:else>
			<tr bgcolor="#E3EFFF" onmouseout="td_onmouseout(this,color_out2)"
				...
				<td class="border_frame_right_bottom" align="center">
					<span	class="style19">
						<s:if test="%{currentStatus=='UNKNOWN'}">
...
<script type="text/javascript">//<![CDATA[
   ...
   $(document).ready(function(){  
 	    $('#exportCdr').click(function(){ 
 	    	createFile("<%=basePath%>export_mobi_cdr.mbv");
 	        return false;  
 	    });  
 	}); 
