...
<div align="center">
<div style="height:40px;"><span><b>Truy v&#7845;n giao d&#7883;ch
</b></span></div>
<s:form action="/airtime_transaction_lv.mbv" id="search_airtime_transaction_lv">
	<table width="70%" class=tinyborder border="0">
		<tr align="left">
			...
			<td width="30%">
				<s:select name="txnModel.connType"
						list="%{#request.providerAccountMap}" value="%{txnModel.connType}" />
			...
			<td>
				...
				<s:textfield name="txnModel.messageId"
						cssStyle="Table_TR" maxlength="100" size="30" value="%{txnModel.messageId}"/>
			</td>
		...
		<tr align="left">
			...
			<td>
				<s:textfield name="txnModel.channelId"
						cssStyle="Table_TR" maxlength="100" size="14" value="%{txnModel.channelId}"/>
			</td>
			<td>
				M&#227; GD (K&#234;nh b&#225;n)
			</td>
		...
		<tr>
			...
			<td>
				<s:select name="txnModel.telcoId"
						list="%{#request.telcoMap}" value="%{txnModel.telcoId}" />
						<s:fielderror cssClass="Error" fieldName="providerId" />
			</td>
			<td>
				 M&#227; GD (H&#7879; th&#7889;ng)
			...
			<td>
				<s:textfield name="txnModel.atTxnId"
						cssStyle="Table_TR" maxlength="100" size="30" value="%{txnModel.atTxnId}"/>
		...
		<tr>
			...
			<td>
				...
				<s:textfield name="txnModel.amount"
						cssStyle="Table_TR" maxlength="100" size="14" value="%{txnModel.amount}"/>
			</td>
			<td>
				&#272;&#7871;n ng&#224;y
			</td>
		...
		<tr>
			...
			<td>
				...
				<s:select name="txnModel.status"
						list="%{#request.statusMap}" value="%{txnModel.status}" />
			</td>
			<td>
...
<TABLE class=tinyborder cellSpacing=0 cellPadding=0 width=90%
	...
	<tr>
		...
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">M&#227; GD (HT)</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">K&#234;nh b&#225;n</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">M&#227; GD (KB)</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">Cty Vi&#7877;n th&#244;ng</span></td>
		...
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">M&#227; GD (KN)</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">Tr&#7841;ng th&#225;i GD</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">ErrorCode</span></td>
	</tr>
	<s:iterator status="status" value="%{#request.pageView.items}">
		...
		<s:else>
			<tr bgcolor="#E3EFFF" onmouseout="td_onmouseout(this,color_out2)"
				...
				<td class="border_frame_right_bottom" align="center">
					<span	class="style19">
						<s:if test="%{currentStatus=='SUCCESS' || currentStatus=='ERROR'}">
							<a href="<%=basePath%>airtime_transaction_uv.mbv?txnModel.atTxnId=<s:property value='atTxnId'/>"><s:property value="atTxnId"/></a>
						</s:if>
						<s:else>
...
<script type="text/javascript">//<![CDATA[
   ...
   $(document).ready(function(){  
 	    $('#exportExcelBtn').click(function(){ 
 	    	createReport("<%=basePath%>airtime_transaction_rpt.mbv");
 	        return false;  
 	    });  
 	}); 
   ...
   function createReport(url){
 	  ...
 	  $.ajax({
	            ...
	            type: 'POST',
	            cache: false,
	            data:  $("#search_airtime_transaction_lv").serialize(),
   ...
   function checkRequest(url,reportId){
 	  $.ajax({
	            ...
	            type: 'POST',
	            cache: false,
	            data:  "reportId="+reportId+"&fileName=<%=FeConstant.REPORT_TXN_INFO_FILENAME%>",
	            success: function(data){
	            //alert(data);
	            var getData = $.parseJSON(data);
	  	          try
