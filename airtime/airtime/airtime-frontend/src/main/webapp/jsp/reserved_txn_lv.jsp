...
<div align="center">
<div style="height:40px;"><span><b>Truy v&#7845;n giao d&#7883;ch kh&#243;a ti&#7873;n
</b></span></div>
<s:form action="/reserved_txn_lv.mbv" id="search_reserved_txn_lv">
	<table width="70%" class=tinyborder>
		<tr>
			...
			<td>
				<s:textfield name="txnModel.accountId"
						cssStyle="Table_TR" maxlength="100" size="30" value="%{txnModel.accountId}"/>
			</td>
			...
			<td>
				<s:textfield name="txnModel.systemId"
						cssStyle="Table_TR" maxlength="100" size="30" value="%{txnModel.systemId}"/>
			</td>
		...
		<tr>
			...
			<td>
				<s:textfield name="txnModel.referenceId"
						cssStyle="Table_TR" maxlength="100" size="30" value="%{txnModel.referenceId}"/>
			</td>
...
<TABLE class=tinyborder cellSpacing=0 cellPadding=0 width=90%
	...
	<tr>
		...
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">Ma giao d&#7883;ch</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">T&#224;i kho&#7843;n</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">H&#7879; th&#7889;ng</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">M&#227; tham chi&#7871;u</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">S&#7889; ti&#7873;n</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">Lo&#7841;i giao d&#7883;ch</span></td>
...
<script type="text/javascript">//<![CDATA[
    ...
    function createReport(url){
  	  ...
  	  $.ajax({
	            ...
	            type: 'POST',
	            cache: false,
	            data:  $("#search_reserved_txn_lv").serialize(),
