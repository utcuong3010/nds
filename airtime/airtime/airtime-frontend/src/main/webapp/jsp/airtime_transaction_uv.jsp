...
<body>
<div align="center">
<div style="height:40px;"><span><b>Ch&#7881;nh s&#7917;a tr&#7841;ng th&#225;i giao d&#7883;ch
</b></span></div>
<s:form action="/airtime_transaction_u.mbv">
	...
	<tr>
		<td colspan="2">
			M&#227; giao d&#7883;ch :<b> <s:property value="%{txnModel.atTxnId}"/> </b>
			<s:hidden name="txnModel.atTxnId" value="%{txnModel.atTxnId}"/>
		</td>
	</tr>
	<tr>
		<td colspan="2">
			Tr&#7841;ng th&#225;i giao d&#7883;ch hi&#7879;n t&#7841;i :<b>
			<s:if test="%{txnModel.status=='SUCCESS'}">
				Th&#224;nh c&#244;ng
			</s:if>
			<s:if test="%{txnModel.status=='ERROR'}">
				Th&#7845;t b&#7841;i
			</s:if>
	...
	<tr>
		<td colspan="2">
			...
			<s:select name="txnModel.status"
							list="%{#request.statusMap}" value="%{txnModel.status}" /> <s:submit key="button.submit.select"/>
		</td>
