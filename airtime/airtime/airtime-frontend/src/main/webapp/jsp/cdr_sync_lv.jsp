	...
	<table width="70%" class=tinyborder border="0">
		<tr align="left">
			...
			<td>
				...
				<s:textfield name="cdrDataModel.messageId"
						cssStyle="Table_TR" maxlength="100" size="30" value="%{cdrDataModel.messageId}"/>
			</td>
		...
		<tr>
			...
			<td>
				...
				<s:textfield name="cdrDataModel.amount"
						cssStyle="Table_TR" maxlength="100" size="14" value="%{cdrDataModel.amount}"/>
			</td>
		...
		<tr>
			...
			<td>
				...
				<s:select name="cdrDataModel.status"
						list="%{#request.statusMap}" value="%{cdrDataModel.status}" />
			</td>
...
<TABLE class=tinyborder cellSpacing=0 cellPadding=0 width=85%
	...
	<tr>
		...
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">T&#7915; H&#7879; Th&#7889;ng</span></td>
