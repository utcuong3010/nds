...
<body>
<div align="center">
<div style="height:40px;"><span><b>S&#7917;a th&#244;ng tin n&#7841;p ti&#7873;n v&#224;o t&#224;i kho&#7843;n t&#7893;ng
</b></span></div>
<br>
...
<table class=tinyborder cellSpacing=0 cellPadding=0 width=360
	...
	<TBODY>
		...
		<s:form action="/provider_account_load_money_u.mbv">
			...
			<s:hidden name="proAcc.oldTxnId" value="%{proAcc.oldTxnId}" />
		</s:form>
