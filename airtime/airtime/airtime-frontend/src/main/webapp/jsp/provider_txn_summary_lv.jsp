...
<div align="center">
<div style="height:40px;"><span><b>Truy v&#7845;n giao d&#7883;ch v&#7899;i nh&#224; cung c&#7845;p
</b></span></div>
<s:form action="/provider_txn_summary_lv.mbv" id="search_provider_txn_summary_lv">
...
<TABLE class=tinyborder cellSpacing=0 cellPadding=0 width=70%
	...
	<tr>
		...
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">T&#7893;ng giao d&#7883;ch</span></td>
		<td class="tinyborder_td" bgcolor ="#3991C3" align="center"><span class="style18">T&#7893;ng ti&#7873;n</span></td>
	</tr>
		...
		<s:else>
			<tr bgcolor="#E3EFFF" onmouseout="td_onmouseout(this,color_out2)"
				...
				<td class="border_frame_right_bottom" align="right">
					<span	class="style19">
						<s:if test="%{totalTxn==0}">
							-
						</s:if>
						<s:else>
							<s:property value="totalTxn"/>
						</s:else>
					</span>
...
<script type="text/javascript">//<![CDATA[
    ...
    function createReport(url){
  	  ...
  	  $.ajax({
	            ...
	            type: 'POST',
	            cache: false,
	            data:  $("#search_provider_txn_summary_lv").serialize(),
