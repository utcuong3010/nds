...
public class VnPayIdGenerator implements IdGenerator {
	private static final Log log = LogFactory.getLog(VnPayIdGenerator.class);
	...
	public VnPayIdGenerator(long initialValue, long maxValue,
