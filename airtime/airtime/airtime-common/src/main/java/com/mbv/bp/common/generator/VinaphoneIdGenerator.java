...
public class VinaphoneIdGenerator implements IdGenerator {
	private static final Log log = LogFactory.getLog(VinaphoneIdGenerator.class);
	...
	public VinaphoneIdGenerator(long initialValue, long maxValue,
	...
	public void shutdownSeq() throws DaoException{
		if (shutdownFlag.compareAndSet(false, true)){
            if (sequencedId != null)
            {
                ...
                log.info("vnPay Seq is shutdown.");
            }
        }
    }
}
