...
public class VascIdGenerator implements IdGenerator {
	private static final Log log = LogFactory.getLog(VascIdGenerator.class);
	...
	public VascIdGenerator(long initialValue, long maxValue,
