...
public class AirTimeGenerator implements IdGenerator {
	protected static final Log log = LogFactory.getLog(AirTimeGenerator.class);
	...
	public AirTimeGenerator(long initialValue, long maxValue,
	...
	public void shutdownSeq() throws DaoException{
		if (shutdownFlag.compareAndSet(false, true)){
            if (sequencedId != null)
            {
                ...
                log.info("AirTime Seq is shutdown.");
            }
        }
    }
}
