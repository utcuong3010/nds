...
public class ViettelIdGenerator implements IdGenerator {
	private static final Log log = LogFactory.getLog(ViettelIdGenerator.class);
	...
	public ViettelIdGenerator(long initialValue, long maxValue,
