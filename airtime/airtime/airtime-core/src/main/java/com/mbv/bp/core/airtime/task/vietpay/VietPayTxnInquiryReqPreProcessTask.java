...
public class VietPayTxnInquiryReqPreProcessTask
implements Task {
    private static final Log log = LogFactory.getLog((Class)VietPayTxnInquiryReqPreProcessTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        context.put(Attributes.ATTR_DEST_WFP,AppConstants.VIETPAY_SETTINGS.getTxnInquiryDeliveryWfp());
        ...
        reqTemp.setOperatorType(AppConstants.VIETPAY_SETTINGS.getTxnInquiryOperation());
        try {
