 ...
 *  com.mbv.bp.common.forward.VtcCdrForward
...
import com.mbv.bp.common.forward.VtcCdrForward;
...
public class VtcDbUpdateResultTask
implements Task {
    private static final Log log = LogFactory.getLog((Class)VtcDbUpdateResultTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        if (AppConstants.VTC_SETTINGS.isSuccessResponse(responseCode) || AppConstants.VTC_SETTINGS.isUnknownResponse(responseCode)) {
            atTxn.setTxnStatus("SUCCESS");
        } else if (AppConstants.VTC_SETTINGS.isErrorResponse(responseCode)) {
        ...
        VtcCdrForward.getInstance().execute(context);
