...
public class MobifoneNextIdCheckJob
extends AbstractJob {
    private Log log = LogFactory.getLog((Class)MobifoneNextIdCheckJob.class);
    ...
    public void execute() {
        ...
        try {
            ...
            context.put(Attributes.ATTR_WFP_NAME,"wfpMobiFoneNextIdCheckPushToQueue");
