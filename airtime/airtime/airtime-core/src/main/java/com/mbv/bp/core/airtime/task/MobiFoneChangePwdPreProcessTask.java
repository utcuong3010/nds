...
public class MobiFoneChangePwdPreProcessTask
implements Task {
    private static final Log log = LogFactory.getLog((Class)MobiFoneChangePwdPreProcessTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        context.put(Attributes.ATTR_DEST_WFP,AppConstants.MOBIFONE_SETTINGS.getChangePwdDeliveryTaskWfp());
        ...
        reqTemp.setOperatorType(AppConstants.MOBIFONE_SETTINGS.getChangePasswordOperation());
        try {
