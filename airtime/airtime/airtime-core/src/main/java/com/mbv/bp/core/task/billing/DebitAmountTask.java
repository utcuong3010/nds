...
public class DebitAmountTask
implements Task {
    private static final Log log = LogFactory.getLog((Class)DebitAmountTask.class);
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        String errorCode = amountManager.debitLockAccount((String)context.get(Attributes.ATTR_OPERATION), (String)context.get(Attributes.ATTR_REQUEST_TXN_ID), (String)context.get(Attributes.ATTR_CHANNEL_ID), (String)context.get(Attributes.ATTR_RESERVED_ID), (String)context.get(Attributes.ATTR_REFERENCE_ID), context.getLong(Attributes.ATTR_AMOUNT), (String)context.get(Attributes.ATTR_DESCRIPTION));
