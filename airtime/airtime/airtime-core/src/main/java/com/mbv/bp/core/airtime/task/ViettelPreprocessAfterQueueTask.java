 ...
 *  com.mbv.bp.common.util.ViettelUtils
...
public class ViettelPreprocessAfterQueueTask
implements Task {
    ...
    public boolean execute(ContextBase context) throws Exception {
        ...
        if (AppConstants.VIETTEL_SETTINGS.isAmountValidate()) {
        ...
        try {
            String message = ViettelUtils.serializeTopupMessage((String)context.getString(Attributes.ATTR_MSISDN), (String)context.getString(Attributes.ATTR_AMOUNT), (Date)txnDate, (String)context.getString(Attributes.ATTR_MESSAGE_ID));
