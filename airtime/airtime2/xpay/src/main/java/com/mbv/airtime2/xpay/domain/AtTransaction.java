...
public class AtTransaction implements java.io.Serializable {
	...
	public String toString() {
		return "AtTransaction [txn_id=" + txn_id + ", channel_id=" + channel_id
				+ ", deleted=" + deleted + ", txn_date=" + txn_date
				+ ", at_txn_id=" + at_txn_id + ", delivery_date="
				+ delivery_date + ", response_date=" + response_date
				+ ", amount=" + amount + ", message_id=" + message_id
				+ ", msg_type=" + msg_type + ", msisdn=" + msisdn
				+ ", server_id=" + server_id + ", telco_id=" + telco_id
				+ ", conn_type=" + conn_type + ", txn_type=" + txn_type
				+ ", time_out=" + time_out + ", status=" + status
				+ ", error_code=" + error_code + ", txn_status=" + txn_status
				+ ", created_by=" + created_by + ", created_date="
				+ created_date + ", updated_by=" + updated_by
